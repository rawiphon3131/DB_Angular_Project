...
$sql = "SELECT prdp_id,prd_price_pickin,prd_sell,a.prd_id,prd_name_id,prd_name,b.size_id,size_name,b.type_id,type_name,b.type_prd_id,type_prd_name,prd_value FROM product_price_tbl as a
